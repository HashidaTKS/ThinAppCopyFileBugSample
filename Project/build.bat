...
md "%TARGET_DIR%\%DateDir%"
del /f /q "%TARGET_DIR%\%DateDir%\*.exe"
del /f /q "%TARGET_DIR%\%DateDir%\*.alt"
copy "%TARGET_DIR%\*.exe" "%TARGET_DIR%\%DateDir%\" /Y
copy "%TARGET_DIR%\*.alt" "%TARGET_DIR%\%DateDir%\" /Y
echo Build complete
